...
**Student** 객체를 생성하고 Spring Controller와 Tymeleaf를 이용하여 학생 정보를 **CRUD** 하는 간단한 예제를 실습해 보았다.
...
`form`에서 학생 정보 ***Student("21000004", "Lauv", 26, "1994-08-08")*** 입력 후 컨트롤러에서 학생 목록 페이지로 리다이렉트 시켜보았다.
